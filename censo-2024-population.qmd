...
pop_muni <- pop_muni |> left_join(crosswalk_muni, by = c("municipio" = "muni_cpv2024", 
                                             "departamento" = "department")) |> 
  relocate(ine_code, municipio, provincia, departamento, area, nivel) 

pop_muni_urb_rural <- pop_muni_urb_rural |> 
  left_join(crosswalk_muni, by = c("municipio" = "muni_cpv2024", 
                                             "departamento" = "department")) |> 
  relocate(ine_code, municipio, provincia, departamento, area, nivel)


pop_prov <- pop_prov |> left_join(crosswalk_prov, by = c("provincia" = "province_cpv2024", 
                                             "departamento" = "department")) |> 
  relocate(ine_code, provincia, departamento, area, nivel) |> 
  select(-municipio)

pop_prov_urb_rural <- pop_prov_urb_rural |> 
...
pop_dept_urb_rural <- pop_dept_urb_rural |> 
  left_join(dep_crosswalk, by = c("departamento" = "department")) |> 
  relocate(id_dep, departamento, area, nivel) |> 
  select(-provincia, -municipio)
...
english_var_name_fix <- function(x) {
  x |> rename(department = departamento, province = provincia, 
              municipality = municipio, level = nivel) |>
...
saveRDS(pop_raw,           "data/cpv2024/poblacion_raw.rds")
saveRDS(pop_country,       "data/cpv2024/poblacion_pais.rds")
saveRDS(pop_dept,          "data/cpv2024/poblacion_departamento.rds")
saveRDS(pop_dept_urb_rural,"data/cpv2024/poblacion_departamento_urb_rural.rds")
saveRDS(pop_prov,          "data/cpv2024/poblacion_provincia.rds")
saveRDS(pop_prov_urb_rural,"data/cpv2024/poblacion_provincia_urb_rural.rds")
saveRDS(pop_muni,          "data/cpv2024/poblacion_municipio.rds")
saveRDS(pop_muni_urb_rural,"data/cpv2024/poblacion_municipio_urb_rural.rds")
