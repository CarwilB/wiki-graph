...
*This page was generated using the Posit AI plug-in running Claude Sonnet 4.6, operating in my repository wiki-graph, which already contained the functions referenced here. The prompt I used was:*
...
*The page reflects manual and automated revisions to the code following a debugging process.*
:::
