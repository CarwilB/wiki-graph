...
Export to a plain-text file for pasting into the QuickStatements batch interface at <https://qs-dev.toolforge.org/>. This website offers another round of previewing, showing what changes are being made, how they ore sourced etc. It's also possible to execute just the initial lines, look at the results on wikidata.org, then proceed.
